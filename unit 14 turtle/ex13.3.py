...
def draw_leaf():
    pen.fillcolor("green")  # Leaf color
    pen.begin_fill()
    pen.circle(30, 60)  # Draw first half of leaf shape
    pen.left(120)
    pen.circle(30, 60)  # Draw second half of leaf shape
    pen.end_fill()
...
def animate_tree():
    for level in range(1, levels + 1):
        ...
        turtle.delay(0)  # Pause briefly before drawing next level (optional)
